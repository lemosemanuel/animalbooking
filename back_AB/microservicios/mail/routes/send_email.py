...
def sendEmail():
    # me envian el id de la persona y la orden de crear un numero
    # este lo creo y lo guardo en avatar_credentials
    ...
    if respuesta['send_email']==True:
        ...
        receiver_email_address = "lemos.ema@gmail.com" 
    ...
    return jsonify({"message":"Code created Succesfully", "products":codigo})
