              ...
              CardContainer(
                child: Column(
                  children: [
                    ...
                    Text("Registro",style: TextStyle(fontSize: 33,fontWeight: FontWeight.bold,color: Colors.black45),),
        ...
        child: Column(
          children: [
            ...
            TextButton(
              ...
              child: const Text('Ya tienes cuenta? click aqui !',style: TextStyle(fontSize: 18,color: Colors.black38),))
  ...
  MaterialButton _buttonLogin(BuildContext context,LoginFormProvider loginForm) {
    return MaterialButton(
            ...
            child: Container(
              ...
              child: Text(loginForm.isLoading?'Espere':'Registrarse',style: const TextStyle(color: Colors.white),),
            ),
          );
  }
